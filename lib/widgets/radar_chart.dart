...
class RadarRatingChart extends CustomPainter{
  RadarRatingChart({
    required this.rating,
    required this.features,
    required this.radarChartBackground
  });
  List<double> rating;
  List<String> features;
  Color radarChartBackground;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int j = 0; j < ratingData.length; j++) {
      ...
      Paint circlePointerPaint = Paint()
        ..color = Colors.red
